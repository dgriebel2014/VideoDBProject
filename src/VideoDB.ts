...
export class VideoDB {
    ...
    public async getMultiple(storeName: string, keys: string[]): Promise<(any | null)[]> {
        ...
        const perKeyMetrics: Record<string, number> = {
            findMetadata: 0,
            createBuffer: 0,
            copyBuffer: 0,
            mapBuffer: 0,
        ...
        const mapBufferSubsections: Record<string, number> = {
            mapAsync: 0,
            getMappedRange: 0,
            copyToUint8Array: 0,
            unmap: 0,
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            commandEncoder.copyBufferToBuffer(
                this.getBufferByIndex(storeMeta, rowMetadata.bufferIndex), // source buffer
